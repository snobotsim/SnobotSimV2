...
public class SwerveModuleSim {
    ...
    {
        this(
                azimuthMotor, wheelMotor, wheelRadiusM, azimuthGearRatio, wheelGearRatio,
                1.0,
                1.0,
                1.1,
                0.8,
    ...
    public double getAzimuthEncoderPositionRads() {
        return Units.rotationsToRadians(getAzimuthEncoderPositionRev());
    }
    ...
    public double getAzimuthEncoderVelocityRadPerSec() {
        return Units.rotationsPerMinuteToRadiansPerSecond(getAzimuthEncoderVelocityRpm());
    }
    ...
    public double getWheelEncoderMetersPerSecond() {
        return m_wheelMotor.getWheelSpeedMetersPerSecond() * m_wheelEncGearRatio;
    }
...
//        System.out.println("Velocity along azimuth... " + velocityAlongAzimuth);
