...
public class FlywheelSimWrapper extends BaseSingleGearboxSimWrapper
{
    ...
    public FlywheelSimWrapper(FlywheelSim flywheelSim, SpeedController motor, Encoder encoderWrapper)
    {
        this(flywheelSim, new WpiSpeedControllerWrapper(motor), new WpiEncoderWrapper(encoderWrapper));
    }
